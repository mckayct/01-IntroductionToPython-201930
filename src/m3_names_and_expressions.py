...
#   Run your code (fix errors as needed), then change the above _TODO_ to DONE.
###############################################################################
todo3 = math.sqrt((41 * 88) + (4 * math.cos(2)))
print(todo3)
###############################################################################
# DONE: 4.
...
# I think "hello"  'hello'  'a b c' 'math' are a strings
############################
print(type("hello"))
print(type('hello'))
print(type('a b c'))
...
#I do not know what type 3 + 3   2 ** 100  or 2.0 **100 is
#############################
print(type(3 + 3))
print(type(2 ** 100))
print(type(2.0 ** 100))
# the first two are int, and the last one is a float because of the .0
#############################


# I do not know these last ones, but I will enter them and see what they are
###################
...
### I now know that they are float, built in function or module, and module
######################
